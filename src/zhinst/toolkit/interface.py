"""Interface function and classes for the zhinst.toolkit."""
...
class MappingMode(Enum):
    """SHFQA Sweeper frequency range mapping"""

    LIN = "linear"
    LOG = "log"


class TriggerImpedance(Flag):
    """SHFQA Trigger input inpedance

    OHM50: Trigger input impedance is set to 50 Ohm

    OHM1K: Trigger input impedance is set to 1 kOhm
    """
